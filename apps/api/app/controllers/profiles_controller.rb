class ProfilesController < ApplicationController
  ...
  def update
    ...
    if password_change_requested?
      return render_validation_errors("Current password is required") if profile_params[:current_password].blank?
      return render_validation_errors("Current password is incorrect") unless current_user.authenticate(profile_params[:current_password])
  ...
  def render_validation_errors(message)
